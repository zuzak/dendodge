	<h2>Portfolio</h2>
		...
		<h3>Audio restoration</h3>
			<strong>È Scherzo od è Follia <a href="https://commons.wikimedia.org/wiki/File:Caruso_et_al_-_%C3%88_scherzo_od_%C3%A8_follia.ogg" class="ext">(info)</a></strong><br/>
				...
				Digitally-restored audio recording of Enrico Caruso, <i lang="la">et al</i>, singing Guiseppe Verdi's <cite class="section"><span lang="it" class="translation" title="It is a Joke or It is Madness">È&nbsp;Scherzo&nbsp;od&nbsp;è&nbsp;Follia</span></cite>, from the opera <cite lang="it" title="A Masked Ball" class="translation">Un&nbsp;Ballo&nbsp;in&nbsp;Maschera</cite>.
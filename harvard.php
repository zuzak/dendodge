...
if (!isset($_GET["type"])) {
	...
	echo "<form action=\".\" method=\"get\"><input type=\"hidden\" name=\"p\" value=\"harvard\" /><fieldset><legend>Work</legend> <strong>Type of work:</strong> (required) <input type=\"radio\" name=\"type\" id=\"book\" value=\"book\" data-targets=\"boxBook\" checked=\"checked\" /> <label for=\"book\">Book</label> <input type=\"radio\" name=\"type\" id=\"journal\" value=\"journal\" data-targets=\"boxJournal\" /> <label for=\"journal\">Journal</label> <input type=\"radio\" name=\"type\" id=\"website\" value=\"website\" data-targets=\"boxWebsite\" /> <label for=\"website\">Website</label><br/><label for=\"title\"><strong>Title:</strong></label> <input type=\"text\" name=\"title\" id=\"title\" class=\"required\" required=\"required\" placeholder=\"required\" size=\"106\" x-webkit-speech=\"x-webkit-speech\" /><br/><label for=\"year\"><strong>Year of first publication:</strong></label> <input type=\"number\" name=\"year\" id=\"year\" class=\"required\" required=\"required\" placeholder=\"required\" /></fieldset><fieldset><legend>Authors</legend><strong>Author 1:</strong> <input type=\"text\" name=\"fn\" id=\"fn\" class=\"required\" required=\"required\" placeholder=\"First name (required)\" x-webkit-speech=\"x-webkit-speech\"/> <input type=\"text\" name=\"sn\" id=\"sn\" class=\"required\" required=\"required\" placeholder=\"Surname (required)\" x-webkit-speech=\"x-webkit-speech\" /><br/><strong>Author 2:</strong> <input type=\"text\" name=\"fn2\" id=\"fn2\" placeholder=\"First name\" x-webkit-speech=\"x-webkit-speech\" /> <input type=\"text\" name=\"sn2\" id=\"sn2\" placeholder=\"Surname\" x-webkit-speech=\"x-webkit-speech\" /><br/><label for=\"threeauthors\">Check this box if the work has three or more authors:</label> <input type=\"checkbox\" name=\"threeauthors\" id=\"threeauthors\" value=\"1\" /></fieldset><fieldset id=\"boxBook\"><legend>Book</legend><label for=\"bookpages\" class=\"labelwidth\">Page(s):</label> <input type=\"text\" name=\"bpages\" id=\"bookpages\" /> (e.g., <q>3</q> or <q>6-10</q>)<br/><label for=\"chapter\" class=\"labelwidth\">Chapter name:</label> <input type=\"text\" name=\"chapter\" id=\"chapter\" x-webkit-speech=\"x-webkit-speech\" /> (e.g., <q>Chapter One</q> or <q>The Boy Who Lived</q>)<br/><label for=\"place\" class=\"labelwidth\">Place of publication:</label> <input type=\"text\" name=\"place\" id=\"place\" x-webkit-speech=\"x-webkit-speech\" /> (e.g., <q>London</q>)<br/><label for=\"editor\" class=\"labelwidth\">Editor:</label> <input type=\"text\" name=\"editor\" id=\"editor\" x-webkit-speech=\"x-webkit-speech\" /> (e.g., <q>Doe, J</q>)<br/><label for=\"pub\" class=\"labelwidth\">Publisher:</label> <input type=\"text\" name=\"pub\" id=\"pub\" x-webkit-speech=\"x-webkit-speech\" /> (e.g., <q>Harvard University Press</q>)</fieldset><fieldset id=\"boxJournal\"><legend>Journal</legend><label for=\"journalname\" class=\"labelwidth\">Journal name:</label> <input type=\"text\" name=\"journalname\" id=\"journalname\" class=\"required\" placeholder=\"required\" x-webkit-speech=\"x-webkit-speech\" /> (e.g., <q>Nature</q>)<br/><label for=\"vol\" class=\"labelwidth\">Volume:</label> <input type=\"text\" name=\"vol\" id=\"vol\" /> (e.g., <q>12</q>)<br/><label for=\"part\" class=\"labelwidth\">Part:</label> <input type=\"text\" name=\"part\" id=\"part\" /> (e.g., <q>2</q>; only used when a volume is specified)<br/><label for=\"journalpages\" class=\"labelwidth\">Page(s):</label> <input type=\"text\" name=\"jpages\" id=\"journalpages\" /> (e.g., <q>3</q> or <q>6-10</q>)</fieldset><fieldset id=\"boxWebsite\"><legend>Website</legend><label for=\"url\" class=\"labelwidth\">URL:</label> <input type=\"text\" name=\"url\" id=\"url\" class=\"required\" placeholder=\"required\" /> (e.g., <q>http://dendodge.me?p=harvard</q>)<br/><label for=\"date\" class=\"labelwidth\">Date of most recent access:</label> <input type=\"date\" name=\"date\" id=\"date\" class=\"required\" value=\"" . date("Y-m-d") . "\" /> (e.g., <q>" . date("d/m/Y") . "</q>)</fieldset><input type=\"submit\" value=\"Harvardize me!\" /></form>";
